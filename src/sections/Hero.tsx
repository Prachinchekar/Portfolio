  ...
  return (
    <section className="relative min-h-screen pt-20 flex flex-col justify-center items-center text-center px-4 sm:px-6 overflow-hidden">
      ...
      <motion.div
        ...
        className="mt-10 flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center items-center"
      >
        <MagneticButton>
          <a
            href="#projects"
            className="block w-full sm:w-auto text-center px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg font-semibold hover:scale-105 transition shadow-lg"
          >
            View Projects
          </a>
        </MagneticButton>
        ...
        <MagneticButton>
          <a
            href="#contact"
            className="block w-full sm:w-auto text-center px-6 py-3 border border-white/30 rounded-lg hover:bg-white hover:text-black transition"
          >
            Contact Me
          </a>
        </MagneticButton>
